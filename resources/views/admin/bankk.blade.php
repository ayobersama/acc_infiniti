    ...
    <div class="main-content">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="mb-2">
                        @if($hak_akses['tambah'])
                            <a href="{{ route('bankk.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>    
                        @endif
                    </div>    
                        ...
                        <tbody>
                            @foreach ($bankk as $data)
                                <tr>
                                    ...
                                    <td width="120">
                                        <form action="{{ route('bankk.destroy', $data->bukti)}}" method="post">
                                            @if($hak_akses['edit'])
                                                <a href="{{ route('bankk.edit', $data->bukti)}}" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> Edit</a>
                                            @endif 
                                            @if($hak_akses['hapus'])
                                                @csrf
                                                @method('DELETE')
