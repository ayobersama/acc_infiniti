...
@section('content')
    ...
    <div class="breadcrumbs">      
        <ul class="breadcrumb">
            ...
            <li>
                <a href="{{ url('admin/bankk') }}">Bank Keluar</a>
            </li>
            <li class="active">Edit Bank Keluar</li>
        </ul><!-- /.breadcrumb -->
    </div>
        ...
        <div class="container">
                    ...
                    <div class="row p-2">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    <div class="input-group">
                                      <input type="text" class="form-control" id="bukti" name="bukti" maxlength="10" value="{{$bankk->bukti}}" readonly>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control" id="bank" name="bank">
                                        ...
                                        <option value="{{$kl->id}}"  @if($kl->id==$bankk->bank) selected="selected" @endif>{{$kl->nama}}</option>
                                        @endforeach
                                    </select>    
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control" id="relasi" name="relasi">
                                        ...
                                        <option value="{{$rl->id}}" @if($rl->id==$bankk->relasi) selected="selected" @endif>{{$rl->nama}}</option>
                                        @endforeach
                                    </select>   
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control date-picker" data-date-format="dd-mm-yyyy" id="tgl" name="tgl" maxlength="12" value="{{FormatTgl($bankk->tgl)}}">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" id="ket" name="ket" value="{{ $bankk->ket }}" maxlength="255">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row text-center mb-2">
                <div class="col-md-12">
                    ...
                    <a href="{{ route('bankk.index') }}" class="btn btn-danger"> Batal</a>
                </div>
            </div>      
        </div>
    </div>    
...
@push('js')
    ...
    $('#nilai').keypress(function(event) {
        ...
        $('#form_trans').submit(function(e) {
            ...
            $.ajax({
                type:'post',
                url: "{{ route('bankk.update', $bankk->bukti) }}",
                data: formData,
                cache:false,
                contentType: false,
                processData: false,
                ...
                success: function(response){
                    if(response["success"]){
                        if(termasuk_detail=='Y'){
                            simpan_detail();
                        } else window.location.replace("{{ url('admin/bankk')}}");        
                    } else  alert('Gagal');
                },
                error:function(data){
   	...
   	`` }
        ...
        $('#form_detail').submit(function(e) {
            ...
            var id= $("#id").val();
            var link='';
            if(jns=='i') link="{{ url('admin/simpan_bankkd') }}";
            else link="{{ url('admin/update_bankkd') }}/"+id;
            var formData = new FormData(this);
            var token   = $("meta[name='csrf-token']").attr("content");
            formData.append('_token', token); 
            $.ajax({
