...
@section('content')
    ...
    <div class="breadcrumbs">      
        <ul class="breadcrumb">
            ...
            <li class="active">Tambah Bank Masuk</li>
        </ul><!-- /.breadcrumb -->
    </div>
    <div class="main-content">
        <div class="container">
            ...
            @endif
            <form name="form_trans" id="form_trans" action="{{ route('bankm.store') }}" method="post">
             <div class="card">
                    ...
                    <div class="row p-2">
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control" id="bank" name="bank" data-placeholder="Pilih Bank">
                                        <option value=""></option>
