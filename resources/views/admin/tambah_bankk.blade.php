...
@section('content')
    ...
    <div class="breadcrumbs">      
        <ul class="breadcrumb">
            ...
            <li class="active">Tambah Bank Keluar</li>
        </ul><!-- /.breadcrumb -->
    </div>
    <div class="main-content">
        <div class="container">
            ...
            @endif
            <form name="form_trans" id="form_trans" action="{{ route('bankk.store') }}" method="post">
             <div class="card">
                <div class="card-body" style="padding:7px 5px;">
                    <div class="row p-2">
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label for="alamat" class="col-md-2 col-form-label">Bank</label>
                                <div class="col-md-9">
        ...
        <div class="modal-dialog modal-lg" style="top:120px">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form role="form" class="form-horizontal" id="form_detail" action="{{ url('admin/simpan_bankkd') }}" method="POST">
...
@push('js')
    ...
    $('#nilai').keypress(function(event) {
        ...
        function ambil_nourut(){
            $.ajax({
                url :"{{ url('admin/ambil_nourut/BK') }}",
                type:"get",
                success:function(data){
                    $("#bukti").val(data);
                },
                error:function(data){
                    alert("Gagal ambil No urut");					
                }
            })
        }    
