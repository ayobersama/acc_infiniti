...
@section('content')
    ...
    <div class="main-content">
        <div class="container">
            ...
            @endif
            <form name="form_trans" id="form_trans" action="{{ route('jurum.store') }}" method="post">
             <div class="card">
