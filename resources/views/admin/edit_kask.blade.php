...
@section('content')
    ...
    <div class="breadcrumbs">      
        <ul class="breadcrumb">
            ...
            <li>
                <a href="{{ url('admin/kask') }}">Kas Keluar</a>
            </li>
        ...
        <div class="container">
                    ...
                    <div class="row p-2">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    <div class="input-group">
                                      <input type="text" class="form-control" id="bukti" name="bukti" maxlength="10" value="{{$kask->bukti}}" readonly>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control" id="kas" name="kas">
                                        ...
                                        <option value="{{$kl->id}}"  @if($kl->id==$kask->kas) selected="selected" @endif>{{$kl->nama}}</option>
                                        @endforeach
                                    </select>    
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control" id="relasi" name="relasi">
                                        ...
                                        <option value="{{$rl->id}}" @if($rl->id==$kask->relasi) selected="selected" @endif>{{$rl->nama}}</option>
                                        @endforeach
                                    </select>   
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control date-picker" data-date-format="dd-mm-yyyy" id="tgl" name="tgl" maxlength="12" value="{{FormatTgl($kask->tgl)}}">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" id="ket" name="ket" value="{{ $kask->ket }}" maxlength="255">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row text-center mb-2">
                <div class="col-md-12">
                    ...
                    <a href="{{ route('kask.index') }}" class="btn btn-danger"> Batal</a>
                </div>
            </div>      
        </div>
    </div>    
...
@push('js')
    ...
    $('#nilai').keypress(function(event) {
        ...
        $('#form_trans').submit(function(e) {
            ...
            $.ajax({
                type:'post',
                url: "{{ route('kask.update', $kask->bukti) }}",
                data: formData,
                cache:false,
                contentType: false,
                processData: false,
                ...
                success: function(response){
                    if(response["success"]){
                        if(termasuk_detail=='Y'){
                            simpan_detail();
                        } else window.location.replace("{{ url('admin/kask')}}");       
                    } else  alert('Gagal');
                },
                error:function(data){
   	...
   	`` }
        ...
        $('#form_detail').submit(function(e) {
            ...
            var id= $("#id").val();
            var link='';
            if(jns=='i') link="{{ url('admin/simpan_kaskd') }}";
            else link="{{ url('admin/update_kaskd') }}/"+id;
