...
@section('content')
    ...
    <div class="main-content">
        <div class="container">
            ...
            @endif
            <form name="form_trans" id="form_trans" action="{{ route('kask.store') }}" method="post">
             <div class="card">
                    ...
                    <div class="row p-2">
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control" id="kas" name="kas" data-placeholder="Pilih Kas">
                                        <option value=""></option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control" id="relasi" name="relasi" data-placeholder="Pilih Relasi">
                                        <option value=""></option>
